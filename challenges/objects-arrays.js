...
// tyrannosaurus, carnivorous, 7000kg, 12m, Late 
const tyrannosaurus = {
  name: "tyrannosaurus",
  diet: "carnivorous",
  weight: "7000kg",
...
graduates.forEach(function(name) {
  return fullNames.push(`${name.university}`);
});
...
lowCaseAnimalNames = zooAnimals.map(function(name) {
...
lowPopulationAnimals = zooAnimals.filter(function(pop) {
